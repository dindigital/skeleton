...
class PluploadPainel implements iUploadBuilder
{
  ...
  {
    if ( is_null($uploader) ) {
      $uploader = '/adm/plugins/plupload/upload.php';
    }
    ...
    $Upl->setOpt('flash_swf_url', "'/adm/plugins/plupload/js/plupload.flash.swf'");
    $Upl->setOpt('silverlight_xap_url', "'/adm/plugins/plupload/js/plupload.silverlight.xap'");
