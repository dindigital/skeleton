...
(function($) {
  ...
  $.widget("ui.multiselect", {
    ...
    _create: function() {
      ...
      this.availableActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><input type="text" placeholder="Busca" class="search empty ui-widget-content ui-corner-all"/><a href="#" class="add-all">'+$.ui.multiselect.locale.addAll+'</a></div>').appendTo(this.availableContainer);
  ...
  $.extend($.ui.multiselect, {
    locale: {
      ...
      itemsCount:'iten(s) selecionado(s)'
    }
  });
