 ...
 */
        ...
        CKFINDER.skins.add('kama', (function() {
          ...
          return{preload: a, application: {css: ['app.css']}, host: {intoHostPage: 1, css: ['host.css']}, marginMainContainer: 7, marginSidebarContainer: 7, fixMainContentWidth: 1, init: function(b) {
              ...
              function g(i, j, k) {
                ...
                for (var o = 0; o < i.length; o++) {
                  if (CKFINDER.env.webkit) {
                    for (m = 0; m < i[o].$.sheet.rules.length; m++)
                      i[o].$.sheet.removeRule(m);
                    for (m = 0; m < j.length; m++) {
                      n = j[m][1];
                      for (l = 0; l < k.length; l++)
                        n = n.replace(k[l][0], k[l][1]);
              ...
              ;
              var h = /\$color/g;
              CKFINDER.tools.extend(b, {uiColor: null, getUiColor: function() {
                  return this.uiColor;
