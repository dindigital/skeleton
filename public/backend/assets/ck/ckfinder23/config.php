...
$config['LicenseName'] = 'DIN DIGITAL WEB';
$config['LicenseKey'] = '3EQV-JCVY-NGXN-ECVC-KVMP-7E4Z-ARUS';
...
/*
  ...
  ATTENTION: The trailing slash is required.
 */
$baseDir = resolveUrl('/public/system/uploads/ck/');
...
$config['ResourceType'][] = Array(
    ...
    'maxSize' => 0,
    'allowedExtensions' => 'avi,flv,mp4,mpc,mpeg,mpg',
    'deniedExtensions' => '');
